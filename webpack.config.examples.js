...
module.exports = {
    target: "web", // webpack-dev-server will monitor the code dependency
    ...
    devServer: { // Can be omitted unless you are using 'docker' 
        ...
        //   </script>
        publicPath: '/examples', // The local filesystem directory where static html files
        // should be placed.
        ...
        contentBase: path.resolve(__dirname, "./"), // 'Live-reloading' happens when you make changes to code
